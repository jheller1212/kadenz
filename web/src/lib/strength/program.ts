...
export const EXERCISES: ExerciseDef[] = [
  ...
  // ── Bench work ─────────────────────────────────────────────────────────────
  // A bench used to unlock exactly ONE exercise for a dumbbell owner
  // (dumbbell_bench_press). The catalogue's other three bench movements all
  // additionally require a barbell, so ticking "Bench" in the equipment picker
  // changed 44 available exercises to 45 — the picker implied real choice and
  // delivered almost none. These six are the staple dumbbell-and-bench
  // movements that were simply missing; the last two need only the bench.
  {
    ...
    category: "upper",
    equipmentNote: "Bench set to roughly 30 degrees — steeper turns it into a shoulder press",
    tempoNote: "Lower under control until the elbows are level with the torso",
    defaultSets: 3,
    repLow: 8,
    repHigh: 12,
    startWeightKg: 10,
  },
  {
    ...
    category: "upper",
    equipmentNote: "One knee and one hand on the bench, opposite arm rowing",
    tempoNote: "Pull to the hip, not the armpit — no torso twist",
    defaultSets: 3,
    repLow: 8,
    repHigh: 12,
    startWeightKg: 12.5,
  ...
  {
    slug: "db_bulgarian_split_squat",
    equipment: ["dumbbell", "bench"],
    primaryMuscle: "Quads",
    secondaryMuscles: ["Glutes", "Core"],
    name: "Bulgarian split squat",
    category: "lower",
    equipmentNote: "Rear foot on the bench, dumbbells at your sides",
    tempoNote: "Weight through the front heel, torso tall",
    defaultSets: 3,
    repLow: 8,
    repHigh: 12,
    startWeightKg: 10,
  },
  {
    ...
    category: "lower",
    equipmentNote: "Shoulder blades on the bench, dumbbell across the hips",
    tempoNote: "Drive the hips to level, 1 s squeeze, ribs down",
    defaultSets: 3,
    repLow: 10,
    repHigh: 15,
    startWeightKg: 15,
  },
  {
    ...
    name: "Bench dip",
    category: "upper",
    equipmentNote: "Hands on the bench edge, heels on the floor",
    tempoNote: "Elbows straight back, stop if the shoulders complain",
    defaultSets: 3,
    repLow: 8,
    repHigh: 15,
  },
  {
    ...
    category: "upper",
    equipmentNote: "Feet on the bench — harder than a floor push-up, and biased to the upper chest",
    tempoNote: "Body in one line, chest to just above the floor",
    defaultSets: 3,
    repLow: 8,
    repHigh: 15,
